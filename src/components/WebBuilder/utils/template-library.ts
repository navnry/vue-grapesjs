...
<header class="fixed left-8 right-8 top-6 bg-white rounded-full z-10">
    <div class="grid grid-cols-[1fr_auto_1fr] items-center relative">
        <div class="ml-9">
            <a href="/">
        ...
        <nav>
            <ul class="flex">
                <li class="group">
                    <a href="" class="block leading-[72px] px-9">
                        Product
                    </a>

                    <div
                            class="
      absolute left-0 top-full w-full pt-5
    ...
    "
                    >
                        <div class="grid grid-cols-2 bg-white rounded-[36px] p-12 shadow-xl">
                            <div class="flex flex-col gap-7 mr-[196px]">
                                <h3 class="text-[36px] font-semibold leading-[1.5]">
                                    Classification
                                </h3>

                                <ul class="flex flex-col">
                                    <li>
                                        <a href="" class="py-[14px] block border-b border-t hover:text-primary">
                                            Carbon Black Masterbatch
                                        </a>
                                    </li>
                                    <li>
                                        <a href="" class="py-[14px] block border-b hover:text-primary">
                                            White Masterbatch
                                        </a>
                                    </li>
                                    <li>
                            ...
                            <div>
                                <img src="https://via.nplaceholder.com/630x420.png" alt=""/>
                            </div>
                        </div>
                    </div>
                </li>
                ...
                <li class="group">
                    <a href="" class="block leading-[72px] px-9">Application</a>
                    <div
                            class="
                                  absolute left-0 top-full w-full pt-5
                                  opacity-0 invisible translate-y-2
                ...
                <li><a href="" class="block leading-[72px] px-9">About</a></li>
                <li><a href="" class="block leading-[72px] px-9">Blog</a></li>
                <li><a href="" class="block leading-[72px] px-9">Contact Us</a></li>
            </ul>
        </nav>
        <div class="flex justify-end mr-3 items-center gap-7">
            <a href="" class="block w-7 h-7 text-blue-600 hover:text-blue-800">
                <svg class="icon" fill="currentColor" viewBox="0 0 1024 1024" version="1.1"
                     xmlns="http://www.w3.org/2000/svg" width="24" height="24">
                    <path d="M497.810286 146.249143C303.652571 146.249143 146.285714 300.141714 146.285714 489.947429c0 189.842286 157.366857 343.771429 351.524572 343.771428 83.017143 0 159.305143-28.16 219.428571-75.227428l114.285714 111.433142 3.035429 2.56c10.605714 7.68 25.6 6.802286 35.218286-2.56a26.075429 26.075429 0 0 0-0.036572-37.485714l-112.932571-110.116571a338.358857 338.358857 0 0 0 92.525714-232.374857C849.298286 300.141714 691.931429 146.285714 497.773714 146.285714z m0 52.955428c164.205714 0 297.325714 130.194286 297.325714 290.742858 0 160.621714-133.12 290.816-297.325714 290.816-164.242286 0-297.398857-130.194286-297.398857-290.779429 0-160.621714 133.12-290.779429 297.398857-290.779429z"/>
                </svg>
            </a>
            <a href="" class="bg-[#0057CE] text-white rounded-full px-6 py-3 font-medium">
                Send Inquiry
            </a>
        </div>
    </div>
...
<section>
    <div class="w-full h-[55.56vw] max-h-screen">
        <img src="./img/banner.png" alt="" class="w-full h-full object-cover">
    </div>
...
<section class="py-15 lg:py-[100px]">
    <div class="container mx-auto flex flex-col gap-14">
        <div class="grid grid-cols-2 relative">
            <div>
                <h2 class="text-5xl font-semibold white-pre leading-[1.3]">Trusted, Reliable,
                    Experienced</h2>
            </div>
            <div class="flex flex-col gap-4">
                <p>Wuxi Changhong Plastic Color Particle Co., Ltd. is an industrial company established in 1993, dedicated to the production and research and development of plastic masterbatches and chemical fiber masterbatches.</p>
                <a href="" class="px-6 py-3 bg-[#0057CE] self-start rounded-lg text-white">Learn More</a>
            </div>
        </div>
        <div>
            <img src="https://via.nplaceholder.com/1240x587.png" alt="" class="rounded-2xl">
        </div>
        <div class="grid grid-cols-2 relative">
            <div>
                <h2 class="text-5xl font-semibold white-pre leading-[1.3]">Local Expertise, Global Reach</h2>
            </div>
            <div class="flex flex-col gap-4">
                <p>Wuxi Changhong Plastic Color Particle Co., Ltd. is an industrial company established in 1993, dedicated to the production and research and development of plastic masterbatches and chemical fiber masterbatches.</p>
            </div>
        ...
        <div>
            <img src="https://via.nplaceholder.com/1240x640.png" alt="" class="rounded-2xl">
        </div>
        <div>
            <ul class="grid grid-cols-4 gap-4">
                <li class="rounded-2xl border flex flex-col py-8 px-7 gap-2">
                    <div class="text-6xl Staatliches">30+</div>
                    <div class="text-xl leading-[1.2]">Years of Experience</div>
                </li>
                <li class="rounded-2xl border flex flex-col py-8 px-7 gap-2">
                    <div class="text-6xl Staatliches">200+</div>
                    <div class="text-xl leading-[1.2]">Nations of Clients</div>
                </li>
                <li class="rounded-2xl border flex flex-col py-8 px-7 gap-2">
                    <div class="text-6xl Staatliches">360+</div>
                    <div class="text-xl leading-[1.2]">International Patents</div>
                </li>
                <li class="rounded-2xl border flex flex-col py-8 px-7 gap-2">
                    <div class="text-6xl Staatliches">99%</div>
                    <div class="text-xl leading-[1.2]">Product Percent Of Pass</div>
                </li>
            </ul>
        </div>
    </div>
